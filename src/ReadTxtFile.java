...
public class ReadTxtFile {
	...
	/*
	 * This creates a HashMap of QuarterHourCollection objects, each for a fifteen minute time between 0.00am
	 * and 23.45pm. This will be used in storing data
	 */
	private static void initTimes(){
		timesAndValues = new HashMap<String, QuarterHourCollection>();
